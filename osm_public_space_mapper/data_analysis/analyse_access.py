...
def assume_and_clean_access_based_on_space_type(elements: List[OsmElement]) -> None:
    ...
    def assume_access_based_on_space_type(element: OsmElement) -> None:
        space_types_with_access = [
            'public transport stop', 'park', 'playground', 'dog_park', 'place', 'fitness_station',
        ...
        space_types_with_restricted_access = [
            'outdoor_seating', 'sports_centre', 'swimming_pool', 'biergarten', 'miniature_golf',
            'stadium', 'horse_riding',
        ]  # because usually linked to comsumption / fees / hours which might not be recorded in OSM
        space_types_without_access = [
            'allotments', 'construction', 'landfill', 'military', 'railway', 'flowerbed', 'fountain',
